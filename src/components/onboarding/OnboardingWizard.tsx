    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex">
      ...
      <div className="w-80 bg-white shadow-xl border-r border-slate-200 p-6 hidden lg:block">
        ...
        <div className="space-y-4">
          {getVisibleSteps(onboardingData.bankVerification.wantsLegitScript).map((step, index) => (
            <div
              key={step.id}
        ...
        <div className="mt-8 p-4 bg-slate-50 rounded-lg">
          ...
          <div className="w-full bg-slate-200 rounded-full h-2">
            <div
              ...
              style={{ width: `${(Math.min(currentStep, 8) / getVisibleSteps(onboardingData.bankVerification.wantsLegitScript).length) * 100}%` }}
            />
          </div>
